...
describe('SLADashboard', () => {
  ...
  it('renders all trend variants (up, down, stable)', () => {
    const metrics = [
      { name: 'M1', target: '99%', current: '99%', status: 'met' as const, trend: 'up' as const },
      { name: 'M2', target: '99%', current: '99%', status: 'met' as const, trend: 'down' as const },
      { name: 'M3', target: '99%', current: '99%', status: 'met' as const, trend: 'stable' as const },
    ];
  ...
  it('renders at_risk and violated SLA statuses', () => {
    const metrics = [
      { name: 'Risk', target: '99%', current: '98%', status: 'at_risk' as const, trend: 'up' as const },
      { name: 'Bad', target: '99%', current: '90%', status: 'violated' as const, trend: 'down' as const },
    ];
    render(<SLADashboard metrics={metrics} />);
  ...
  it('renders unresolved violation with XCircle', () => {
    const violations = [
      { id: 'v1', metric: 'Latency Violation', timestamp: '2026-01-01T00:00:00Z', duration: '5 min', impact: 'Some impact', credit: '$50', resolved: false },
    ];
  ...
  it('renders resolved violation with CheckCircle', () => {
    const violations = [
      { id: 'v2', metric: 'Uptime Drop', timestamp: '2026-01-01T00:00:00Z', duration: '10 min', impact: 'Full outage', credit: '$100', resolved: true },
    ];
    render(<SLADashboard violations={violations} />);
  ...
  it('does not show total credits badge when totalCredits is 0', () => {
    const violations = [
      { id: 'v1', metric: 'TestMetric', timestamp: '2026-01-01T00:00:00Z', duration: '1 min', impact: 'None', credit: '$0', resolved: true },
    ];
    render(<SLADashboard violations={violations} />);
  ...
  it('renders with custom latency and error rate data', () => {
    ...
    render(<SLADashboard latencyData={latencyData} errorRateData={errorRateData} />);
