    ...
    deliveryLogs: [
      {
        ...
        eventType: "credential.issued" as any,
      },
      {
        id: "d2",
        ...
        eventType: "credential.revoked" as any,
...
describe("WebhookManager", () => {
  ...
  it("renders webhook URLs", () => {
    render(<WebhookManager webhooks={mockWebhooks} />);
    expect(
      screen.getByText("https://api.example.com/webhooks/zeroid"),
    ).toBeInTheDocument();
  });
  ...
  it("selects events and enters valid URL to enable form submission", () => {
    ...
    fireEvent.change(
      screen.getByPlaceholderText("https://your-server.com/webhooks/zeroid"),
      {
  ...
  it("copies signing secret to clipboard in add form", async () => {
    ...
    const copyButtons = screen
      .getAllByRole("button")
      .filter((btn) => btn.querySelector('[data-testid="icon-copy"]'));
        ...
        deliveryLogs: [
          {
            ...
            eventType: "identity.created" as any,
          },
        ],
      },
    ];
        ...
        deliveryLogs: [
          {
            ...
            status: "pending" as const,
            timestamp: "2026-03-15T10:00:00Z",
            eventType: "proof.generated" as any,
          },
        ],
      },
    ];
