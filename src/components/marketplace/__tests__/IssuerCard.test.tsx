...
describe("IssuerCard", () => {
  ...
  it("displays description when present", () => {
    render(<IssuerCard issuer={mockIssuer} />);
    expect(
      screen.getByText("Leading credential issuer on the Aethelred network."),
    ).toBeInTheDocument();
  });
  ...
  it("does not display description when not present", () => {
    ...
    expect(
      screen.queryByText("Leading credential issuer on the Aethelred network."),
  ...
  it("applies custom className", () => {
    const { container } = render(
      <IssuerCard issuer={mockIssuer} className="custom-class" />,
    );
  ...
  it("applies custom className in loading state", () => {
    const { container } = render(
      <IssuerCard issuer={mockIssuer} loading className="loading-class" />,
    );
  ...
  it("applies custom className in compact mode", () => {
    const { container } = render(
      <IssuerCard issuer={mockIssuer} compact className="compact-class" />,
    );
