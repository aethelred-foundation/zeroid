...
const mockGaps = [
  ...
  },
  {
    id: "g2",
    name: "AML Screening",
    description: "AML screening cert",
    status: "met" as const,
    priority: "high" as const,
    category: "KYC/AML",
    currentCredential: "AML-CERT-001",
  },
  {
    id: "g3",
    name: "Data Localization",
    description: "Data storage proof",
...
describe("ComplianceGapAnalysis", () => {
  it("renders loading state", () => {
    ...
    expect(
      screen.getByText("Analyzing compliance gaps..."),
    ).toBeInTheDocument();
  });
  ...
  it("applies custom className", () => {
    const { container } = render(
      <ComplianceGapAnalysis className="custom-class" />,
    );
