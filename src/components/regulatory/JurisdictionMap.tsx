...
const REGION_PATHS: Record<
  string,
  { path: string; cx: number; cy: number; label: string }
> = {
  US: {
    path: "M60,120 L180,120 L180,180 L60,180 Z",
    cx: 120,
    cy: 150,
    label: "United States",
  },
  CA: {
    path: "M70,70 L170,70 L170,115 L70,115 Z",
    cx: 120,
    cy: 92,
    label: "Canada",
  },
  EU: {
    path: "M340,100 L430,100 L430,160 L340,160 Z",
    cx: 385,
    cy: 130,
    label: "European Union",
  },
  UK: {
    path: "M310,90 L335,90 L335,120 L310,120 Z",
    cx: 322,
    cy: 105,
    label: "United Kingdom",
  },
  CH: {
    path: "M365,145 L385,145 L385,160 L365,160 Z",
    cx: 375,
    cy: 152,
    label: "Switzerland",
  },
  SG: {
    path: "M560,230 L585,230 L585,250 L560,250 Z",
    cx: 572,
    cy: 240,
    label: "Singapore",
  },
  JP: {
    path: "M620,130 L650,130 L650,165 L620,165 Z",
    cx: 635,
    cy: 147,
    label: "Japan",
  },
  AU: {
    path: "M580,290 L660,290 L660,350 L580,350 Z",
    cx: 620,
    cy: 320,
    label: "Australia",
  },
  AE: {
    path: "M465,195 L495,195 L495,215 L465,215 Z",
    cx: 480,
    cy: 205,
    label: "UAE",
  },
  HK: {
    path: "M590,185 L615,185 L615,205 L590,205 Z",
    cx: 602,
    cy: 195,
    label: "Hong Kong",
  },
  BR: {
    path: "M180,250 L260,250 L260,320 L180,320 Z",
    cx: 220,
    cy: 285,
    label: "Brazil",
  },
  IN: {
    path: "M510,165 L555,165 L555,225 L510,225 Z",
    cx: 532,
    cy: 195,
    label: "India",
  },
  KR: {
    path: "M610,130 L625,130 L625,155 L610,155 Z",
    cx: 617,
    cy: 142,
    label: "South Korea",
  },
  ZA: {
    path: "M390,300 L430,300 L430,340 L390,340 Z",
    cx: 410,
    cy: 320,
    label: "South Africa",
  },
...
const DEFAULT_ROUTES: CrossBorderRoute[] = [
  {
    ...
    to: "EU",
    compliant: true,
    requirements: ["eIDAS 2.0 mapping", "Privacy Shield"],
  },
  {
    from: "US",
    to: "UK",
    compliant: true,
    requirements: ["UK GDPR alignment"],
  },
  {
    from: "EU",
    to: "SG",
    compliant: false,
    requirements: ["MAS credential recognition", "PDPA compliance"],
  },
  {
    from: "JP",
    to: "AU",
    compliant: true,
    requirements: ["APEC CBPR framework"],
  },
...
export default function JurisdictionMap({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative"
        style={{ height: selectedJurisdiction ? 420 : 420 }}
      >
        <svg
          viewBox="0 0 720 400"
        ...
        >
          ...
          {Object.entries(REGION_PATHS).map(([id, region]) => {
            ...
            const status = jurisdiction
              ? STATUS_CONFIG[jurisdiction.status]
        ...
        {Object.entries(STATUS_CONFIG).map(([key, config]) => (
          <div key={key} className="flex items-center gap-1.5">
            <div
              ...
              style={{ backgroundColor: config.fill, opacity: 0.4 }}
            />
            <span className="text-[10px] text-[var(--text-tertiary)]">
              {config.label}
            </span>
