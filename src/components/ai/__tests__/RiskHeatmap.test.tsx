...
describe("RiskHeatmap", () => {
  ...
  it("does not show tooltip when a cell is selected (drill-down open)", () => {
    ...
    fireEvent.mouseEnter(screen.getByText("25"), {
      clientX: 200,
      clientY: 200,
    });
  ...
  it("clicks category in dropdown to filter and then resets with All Categories", () => {
    ...
    const dropdownButtons = screen
      .getAllByRole("button")
      .filter((btn) => btn.className.includes("w-full text-left"));
    ...
    fireEvent.click(filterBtn);
    const allCatDropdownBtns = screen
      .getAllByRole("button")
      .filter(
        (btn) =>
    ...
    const variedData = [
      {
        ...
        score: 10,
        severity: "low" as const,
        factors: [{ name: "F1", score: 10, description: "D1" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        category: "KYC/AML",
        ...
        score: 28,
        severity: "low" as const,
        factors: [{ name: "F2", score: 28, description: "D2" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        category: "Sanctions",
        ...
        score: 40,
        severity: "medium" as const,
        factors: [{ name: "F3", score: 40, description: "D3" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        category: "Sanctions",
        ...
        score: 55,
        severity: "medium" as const,
        factors: [{ name: "F4", score: 55, description: "D4" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        ...
        score: 70,
        severity: "high" as const,
        factors: [{ name: "F5", score: 70, description: "D5" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        category: "Data Privacy",
        ...
        score: 85,
        severity: "high" as const,
        factors: [{ name: "F6", score: 85, description: "D6" }],
        lastUpdated: new Date().toISOString(),
      },
      {
        ...
        score: 95,
        severity: "critical" as const,
        factors: [{ name: "F7", score: 95, description: "D7" }],
        lastUpdated: new Date().toISOString(),
      },
    ];
    render(
    ...
    const sparseData = [
      {
        ...
        score: 30,
        severity: "medium" as const,
        factors: [{ name: "F1", score: 30, description: "D1" }],
        lastUpdated: new Date().toISOString(),
      },
    ...
    const dataWithFactors = [
      {
        ...
        factors: [
          ...
          },
          {
            ...
            score: 60,
            description: "High enforcement",
          },
          {
            name: "Data Risk",
            score: 80,
            description: "Significant data risk",
          },
        ],
        lastUpdated: new Date().toISOString(),
      },
  ...
  it("tooltip shows factor scores with progress bars", () => {
    ...
    fireEvent.mouseEnter(screen.getByText("90"), {
      clientX: 300,
      clientY: 300,
    });
