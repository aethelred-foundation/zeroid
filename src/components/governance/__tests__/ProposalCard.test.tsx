...
const mockProposal = {
  ...
  description: 'Proposal to add a new professional certification credential schema to the ZeroID protocol.',
...
describe('ProposalCard', () => {
  ...
  it('displays proposal title and description', () => {
    render(<ProposalCard proposal={mockProposal as any} />);
    expect(screen.getByText('Add New Credential Schema')).toBeInTheDocument();
    expect(screen.getByText(/Proposal to add a new professional/)).toBeInTheDocument();
  });
  ...
  it('renders View Details button when onViewDetails is provided', () => {
    ...
    render(<ProposalCard proposal={mockProposal as any} onViewDetails={onViewDetails} />);
