...
describe('IdentityPage', () => {
  ...
  it('switches to recovery tab and shows guardians', () => {
    ...
    expect(screen.getByText('Update Recovery Configuration')).toBeInTheDocument();
  });
  ...
  it('shows delegates list when delegates exist', () => {
    ...
    mockUseIdentity.mockReturnValue({
      ...
      delegates: [
        { address: '0xabcdef1234567890abcdef1234567890abcdef12', permissions: ['issue', 'verify'] },
      ],
      isLoading: false,
      createIdentity: jest.fn(),
    ...
    expect(mockRevokeDelegate).toHaveBeenCalledWith('0xabcdef1234567890abcdef1234567890abcdef12');
  });
