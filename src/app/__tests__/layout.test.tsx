...
jest.mock('@rainbow-me/rainbowkit', () => ({
  RainbowKitProvider: ({ children }: any) => <div data-testid="rainbowkit-provider">{children}</div>,
  darkTheme: () => ({}),
}));
...
jest.mock('@/contexts/IdentityContext', () => ({
  IdentityProvider: ({ children }: any) => <div data-testid="identity-provider">{children}</div>,
}));

jest.mock('@/contexts/ProofContext', () => ({
  ProofProvider: ({ children }: any) => <div data-testid="proof-provider">{children}</div>,
}));
