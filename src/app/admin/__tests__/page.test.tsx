...
describe('AdminPage', () => {
  ...
  it('shows activity log entries with different categories and fallback colors', () => {
    ...
    expect(screen.getByText(/Completed sanctions screening/)).toBeInTheDocument();
    ...
    expect(screen.getAllByText(/Created API key|Issued credential/).length).toBeGreaterThan(0);
  });
