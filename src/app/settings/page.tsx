                  ...
                  {[
                    {
                      ...
                      desc: "When a dApp requests verification",
                      enabled: true,
                    },
                    {
                      title: "Credential Expiry",
                      desc: "30 days before a credential expires",
                      enabled: true,
                    },
                    {
                      title: "Governance Proposals",
                      desc: "New proposals and voting deadlines",
                      enabled: true,
                    },
                    {
                      title: "TEE Node Alerts",
                      desc: "When your preferred TEE node is unhealthy",
                      enabled: false,
                    },
                    {
                      title: "Credential Revocation",
                      desc: "If any credential is revoked",
                      enabled: true,
                    },
                  ].map((notif) => (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-[var(--text-secondary)] mt-1 mb-3">
                            Permanently delete your identity and all associated
