...
describe('SettingsPage', () => {
  ...
  it('switches to Privacy tab', () => {
    ...
    expect(screen.getByText('Control what data is shared and how')).toBeInTheDocument();
  ...
  it('switches to Security tab', () => {
    ...
    expect(screen.getByText('Manage security settings for your identity')).toBeInTheDocument();
  ...
  it('switches to Advanced tab and shows danger zone', () => {
    ...
    expect(screen.getByText('Advanced settings and data management')).toBeInTheDocument();
  ...
  it('calls setTheme when clicking theme buttons', () => {
    ...
    const nonTabButtons = allButtons.filter(btn => {
      ...
      return !['General', 'Privacy', 'Notifications', 'Security', 'Advanced'].includes(text);
    });
